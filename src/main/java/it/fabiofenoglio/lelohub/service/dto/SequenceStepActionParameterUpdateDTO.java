...
/**
 * A DTO for the {@link it.fabiofenoglio.lelohub.domain.SequenceStepActionParameter} entity.
 */
public class SequenceStepActionParameterUpdateDTO implements Serializable, HasID {
    ...
    public boolean equals(Object o) {
        ...
        SequenceStepActionParameterUpdateDTO sequenceStepActionParameterDTO = (SequenceStepActionParameterUpdateDTO) o;
    ...
    public String toString() {
        return "SequenceStepActionParameterDTO{" +
            "id=" + getId() +
