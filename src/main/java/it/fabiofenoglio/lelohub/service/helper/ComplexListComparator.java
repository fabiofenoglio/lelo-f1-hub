...
public abstract class ComplexListComparator {

	private ComplexListComparator() {
		// NOP
	}
	
    public static <T1, T2>
        DifferentListsDifference<T1, T2>
        compareSets ( Set<T1> list1, Set<T2> list2, BiPredicate<T1, T2> matcher ) {
        return compareLists ( new LinkedList<> ( list1 ), new LinkedList<> ( list2 ), matcher );
    }

    public static <T1, T2>
        DifferentListsDifference<T1, T2>
        compareLists ( List<T1> list1, List<T2> list2, BiPredicate<T1, T2> matcher ) {
    ...
    public static class DifferentListsDifference<T1, T2> {
