...
import it.fabiofenoglio.lelohub.config.audit.AuditEventConverter;
import it.fabiofenoglio.lelohub.domain.PersistentAuditEvent;
...
import static it.fabiofenoglio.lelohub.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
