...
import { SequenceStepComponent } from 'app/entities/sequence-step/sequence-step.component';
...
describe('Component Tests', () => {
  describe('SequenceStep Management Component', () => {
    let comp: SequenceStepComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SequenceStepComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sequenceSteps && comp.sequenceSteps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
