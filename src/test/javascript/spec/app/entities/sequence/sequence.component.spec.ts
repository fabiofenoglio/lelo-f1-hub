...
import { SequenceComponent } from 'app/entities/sequence/sequence.component';
...
describe('Component Tests', () => {
  describe('Sequence Management Component', () => {
    let comp: SequenceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SequenceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sequences && comp.sequences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
